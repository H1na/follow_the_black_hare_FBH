...
label scene_6 :
    ...
    hide mouse1
    show mouse1
    stub_character "...Отслеживать процент успешных всходов и конечно возвращаться на станцию для зарядки. "
    hide mouse1
    show mouse1
    stub_character "Во второй версии предусматривается возможность самодиагностики, чтобы в случае необходимости прибыть на станцию тех обслуживания."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Прикинь, в бизнесе это плюс, а не минус. "
...
label scene_7:
    ...
    hide mouse1
    show mouse1
    stub_character "А этого, забирай бесплатно."
...
label scene_8:
    ...
    hide mouse1
    show mouse1
    stub_character "Есть вопрос! Общения в реальности мало. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Бредово, но при этом — все так и есть. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Он может узнать о человеке все, если сказать, что искать?"
...
label scene_10 :
    ...
    show mouse1
    stub_character "Что создал я? Чип - нет. "
    hide mouse1
    show mouse1
    stub_character "Его создал дед. Сеть? Ее отец. "
    hide mouse1
    show mouse1
    stub_character "А что сделал я? "
    hide mouse1
    show mouse1
    stub_character "Я просто неудачник, который не может заселить космос."
    narrator "Онка поднял голову вверх. Горький ком встал в горле, когда его взгляд уперся в темный потолок."
    hide mouse1
    show mouse1
    stub_character "Как велик соблазн жалости к себе и как я хочу дойти до конца. "
    hide mouse1
    show mouse1
    stub_character "Но ничего не получается. Для моих целей, не хватает вычислительных мощностей..."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Хотя будто бывает иначе. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Это чертвово озеро единственное место не утыканное ими. "
    hide mouse1
    show mouse1
    stub_character "Самое обидное, я сам об этом попросил. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Твой пароль 4 одинаковые цифры, 2 слова и символ."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Фабрика Чипов создана ради воплощения и внедрения в нашу жизнь великих инновационных идей."
    hide mouse1
    show mouse1
    stub_character "И сегодня я ищу проекты, которые должны увидеть свет. "
    hide mouse1
    show mouse1
    stub_character "Объявляю хакатон! "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Но попасть туда можно только через тест. "
    hide mouse1
    show mouse1
...
label scene_11 :
    ...
    hide mouse1
    show mouse1
    stub_character "Сегодня мы объявляем итоги отбора!"
    hide mouse1
    show mouse1
    stub_character "Решим же, кто достоин вступить на территорию инноваций и успеха!   "
    hide mouse1
    show mouse1
    stub_character "Территорию, где изобретатель сможет потягаться за приз — ресурсы для развития своего изобретения!"
    narrator "Знакомый голос затих. "
    hide mouse1
    show mouse1
    stub_character "Сейчас, вы получите жетоны, решающие судьбу. "
    hide mouse1
    show mouse1
    stub_character "Синий жетон, через года, напомнит вам о неудаче. "
    hide mouse1
    show mouse1
    stub_character "Зеленый — о шансе, а возможно... победе. Фабрика желает вам удачи!"
...
label scene_12 :
    ...
    hide mouse1
    show mouse1
    stub_character "Именно здесь может ожить ваш проект."
    hide mouse1
    show mouse1
    stub_character "А может и не ожить, а может ожить и сразу умереть… "
    hide mouse1
    show mouse1
    stub_character "Ну да ладно. Мы отвлеклись."
    hide mouse1
    show mouse1
    stub_character "По правилам конкурса, вы должны пробыть на Фабрике три дня. "
    hide mouse1
    show mouse1
    stub_character "Если готовы, идите за мной."
    ...
    hide mouse1
    show mouse1
    stub_character "Ах, да! Все свои вещи оставляйте у входа. "
    hide mouse1
    show mouse1
...
label scene_13 :
    ...
    show mouse1
    stub_character "Думаете, я не смотрел Чарли и Шоколадную Фабрику? "
    hide mouse1
    show mouse1
    stub_character "Все ожидают по приходу что-то такое. "
    hide mouse1
    show mouse1
    stub_character "Но у меня сильно круче! В миллион раз!"
    ...
    hide mouse1
    show mouse1
    stub_character "Я же делал тест исходя из того, какие сильные будут конкурсанты."
    ...
    hide mouse1
    show mouse1
    stub_character "Договор о неразглашении действует тысячу лет. "
    hide mouse1
    show mouse1
    stub_character "Все могут входить куда им захочется, лисы в помещениях расскажут о назначении всего. "
    hide mouse1
    show mouse1
    stub_character "Они обязаны вам помогать."
    hide mouse1
    show mouse1
    stub_character "Есть места ОПАСНЫЕ, боюсь есть риск некоторых увечий. "
    hide mouse1
    show mouse1
    stub_character "Прошу заметить, это не покрывается страховкой по документу который вы подписали."
    narrator "Онка закончил фразу, на ходу запуская конкурсантов за одну из дверей."
    narrator "Все вошли в огромную аудиторию."
    hide mouse1
    show mouse1
    stub_character "В ходе конкурса вы должны создать или улучшить свое изобретение."
    hide mouse1
    show mouse1
    stub_character "Конкурс субъективный, цель фабрики — найти потенциально коммерчески успешный проект, на основе чипа выпускаемого моей компанией."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Я рад что вы столь инициативны и успели разделиться на команды. "
    hide mouse1
    show mouse1
    stub_character "Хотя еще час и были бы жертвы."
    hide mouse1
    show mouse1
    stub_character "Но вы играете каждый за себя."
    hide mouse1
    show mouse1
    stub_character "Напоминаю, что за эти 2 дня вы должны подготовить прототип собственного проекта, который бы демонстрировал возможность его реализации. "
    hide mouse1
    show mouse1
    stub_character "Сейчас, у нас будет питч проектов — за минуту вам нужно рассказать о том, что вы создаете и что собираетесь делать на конкурсе."
    ...
    hide mouse1
    show mouse1
    stub_character "Это талантливые и оригинальные применения чипа! "
    hide mouse1
    show mouse1
    stub_character "Но у нас остался последний участник."
    hide mouse1
    show mouse1
...
label scene_14:
    ...
    hide mouse1
    show mouse1
    stub_character "Зафиксируй требования остальных участников. "
    hide mouse1
    show mouse1
    stub_character "И не совершай ошибок."
...
label scene_15:
    ...
    hide mouse1
    show mouse1
    stub_character "Поэтому из-за того, что заставляет меня чувствовать мозг, я не переживаю. "
    hide mouse1
    show mouse1
...
label scene_16:
    ...
    hide mouse1
    show mouse1
    stub_character "Фабрика Чипов – это же технологическая династья."
    hide mouse1
    show mouse1
    stub_character "У лис есть культура связанная с Фабрикой. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Потому и названы номерами три и два, а не Высшие и Низшие."
    narrator "Илли остановился и посмотрел на Аша."
    hide mouse1
    show mouse1
    stub_character "Другие лисы даже не назвали те касты. Они — другие. Увидишь. Просто три и два."
    ...
    hide mouse1
    show mouse1
    stub_character "Шучу, все автоматизировано."
    ...
    hide mouse1
    show mouse1
    stub_character "Убери из Фабрики всех лис, разве она закроется? "
    hide mouse1
    show mouse1
    stub_character "Убери все здания, но юридически она будет существовать. "
    hide mouse1
    show mouse1
    stub_character "А юридическое существование – просто фантазия о которой договорились люди. "
    hide mouse1
    show mouse1
    stub_character "Если подпишем бумаги – будем в них верить."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Кстати, это Фабрика управляет судьбой лис в момент рождения."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Их разница в уровне образования. Любой низший, может стать высшим."
    hide mouse1
    show mouse1
    stub_character "Лисятами они растут вместе получая базовое воспитание."
    hide mouse1
    show mouse1
    stub_character "Затем получают имплант развитого неокортекса и специализацию."
    hide mouse1
    show mouse1
    stub_character "Высшие специализируются на научных дисциплинах, а низшие на обслуживании Фабрики."
    hide mouse1
    show mouse1
    stub_character "Хотя там тоже куча инженерии."
    hide mouse1
    show mouse1
...
label scene_17:
    ...
    hide mouse1
    show mouse1
    stub_character "Но Фабрика все починит."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Я смотрю ты многое узнал, пока тут шастал. "
    hide mouse1
    show mouse1
    stub_character "Сжег бы все тут, что мелочиться. Даже всю лунную станцию."
    hide mouse1
    show mouse1
    stub_character "А то сколько тут зла наверно твориться!"
    ...
    hide mouse1
    show mouse1
    stub_character "Именно поэтому, этому недоразумению удалось попасть только сюда."
    ...
    hide mouse1
    show mouse1
    stub_character "И еще расскажешь где ты был!"
    hide mouse1
    show mouse1
...
label scene_18 :
    ...
    hide mouse1
    show mouse1
    stub_character "А могли копии как лисы – стать функциями, нет?"
    ...
    hide mouse1
    show mouse1
    stub_character "Это было единственное растение, которое смогло жить хоть сколько-то на RDF-13! "
    hide mouse1
    show mouse1
    stub_character "А ты его убила из-за ролика?!"
    narrator "Он схватился за волосы."
    hide mouse1
    show mouse1
    stub_character "Это кошмар. Кто допустил тебя до этого? "
    hide mouse1
    show mouse1
    stub_character "Мне и так постоянно плохо, еще вы!"
    ...
    hide mouse1
    show mouse1
    stub_character "О! Раз я не могу их нарушить, то может ли млечный сок лиан это сделать? "
    hide mouse1
    show mouse1
    stub_character "В нем яда на 10 Лун хватит. Надеюсь, что-то попало тебе в рот!"
    hide mouse1
    show mouse1
...
label scene_20:
    ...
    stub_character "Сейчас люди понимают, что уничтожение — плохая стратегия."
    hide mouse1
    show mouse1
    stub_character "По теории игр самая выгодная — это договориться."
    hide mouse1
    show mouse1
...
label scene_28:
    ...
    hide mouse1
    show mouse1
    stub_character "Это очень серьезно, если нельзя связаться с человеком в сети."
    hide mouse1
    show mouse1
    stub_character "Поэтому я сразу принялся тебя искать."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Сочувствую твоей сестре... Возможно, есть одна безумная идея."
    narrator "Аш не нашелся что сказать, он изо всех сил пытался понять, что говорит Илли."
    hide mouse1
    show mouse1
    stub_character "Чип это то, что фиксирует карту активности мозга вплоть до мощности сигналов в нем. И может передавать эти сигналы обратно в мозг."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Сразу иди на Фабрику Чипов. Жду не дождусь подписания документов."
    jump scene_29
...
label scene_31:
    ...
    hide mouse1
    show mouse1
    stub_character "Не знаю из какой ты, но везде в итоге пьют что-то одурманивающее."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Я не спросил как ты предпочитаешь веселиться: алкоголь, галлюциногены, убийства? "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Особенно в космосе. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Например хочу я розовых крыс — генетика."
    hide mouse1
    show mouse1
    stub_character "Хочу чтоб светялись - системная биология."
    hide mouse1
    show mouse1
    stub_character "Хочешь чтоб они играли с тобой в шашки и жгли твое электричество —"
    hide mouse1
    show mouse1
    stub_character "– умей работать с желязяками. "
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "ИИ которая заботиться о производстве лис. "
    hide mouse1
    show mouse1
...
label scene_32:
    ...
    show mouse1
    stub_character "Я думал, что после того как он получит добро, то восстановит сестру и начнет эксперимент по копированию в тело. "
    hide mouse1
    show mouse1
    stub_character "Но он медлит."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Поэтому... Раз..."
    narrator "Здание дрогнуло. Зашептали лисы. Снова почувствовался толчок."
    hide mouse1
    show mouse1
    stub_character "Я пожалуй пойду, не люблю сцены."
    ...
    hide mouse1
    show mouse1
    stub_character "Сейчас, все должны оставаться в помещениях."
    ...
    hide mouse1
    show mouse1
    stub_character "Положите своего коллегу выспаться с лисятами. "
    hide mouse1
    show mouse1
    stub_character "И дай успокоительное с минимальными побочными действиями."
    jump scene_33
...
label scene_33:
    ...
    hide mouse1
    show mouse1
    stub_character "Ты не видел спящих людей?"
    ...
    hide mouse1
    show mouse1
    stub_character "...И возможность пересадить сознание в тело сделают жизнь людей намного лучше."
    hide mouse1
    show mouse1
    ...
    hide mouse1
    show mouse1
    stub_character "Для итогового теста \"копия-тело\" я выбрал кандидата. "
    hide mouse1
    show mouse1
