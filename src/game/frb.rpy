label scene_1:
    ...
    scene blood_room
    show black regular_sad with Dissolve(DISSOLVE_TIME)
    show black regular_sad with Dissolve(DISSOLVE_TIME)
...
label scene_2 :
    ...
    show black regular_confused with Dissolve(DISSOLVE_TIME)
    narrator "В голове парня мелькнула мысль: \"Что она там делает?\""
    show black regular_angry with Dissolve(DISSOLVE_TIME)
    narrator "Он несся по коридорам станции, пока не остановился перед дверью."
    show black regular_fear with Dissolve(DISSOLVE_TIME)
    ...
    show vechna smile2 with Dissolve(DISSOLVE_TIME)
    ...
    show vechna thinking with Dissolve(DISSOLVE_TIME)
    ...
    show digital_vechna smile1 with Dissolve(DISSOLVE_TIME)
    ...
    show vechna sad with Dissolve(DISSOLVE_TIME)
    ...
    show vechna angry with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    show digital_vechna thinking with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    show digital_vechna smile2 with Dissolve(DISSOLVE_TIME)
    ...
    show black regular_surprised with Dissolve(DISSOLVE_TIME)
    narrator "Исчезла, словно не по своей воле."
    jump scene_3


label scene_3:
    show black sad with Dissolve(DISSOLVE_TIME)
...
label scene_4 :
    ...
    show black regular with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show vechna smile1 with Dissolve(DISSOLVE_TIME)
    vechna "Круто, да? "
    ...
    show black sad_var with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    show black angry_var with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    show black regular_happy1 with Dissolve(DISSOLVE_TIME)
...
label scene_5:
    ...
    vechna "Еда готова?"
    hide vechna
    show black regular_happy2 with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    show black regular_annoyed with Dissolve(DISSOLVE_TIME)
    ...
    show black regular_confused with Dissolve(DISSOLVE_TIME)
    call angry_sad
    show black mood with Dissolve(DISSOLVE_TIME)
...
label scene_6 :
    ...
    hide black
    show maks regular with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show maks angry with Dissolve(DISSOLVE_TIME)
...
label scene_7:
    ...
    show onka regular with Dissolve(DISSOLVE_TIME)
    ...
    hide onka
    show fox collar_smile with Dissolve(DISSOLVE_TIME)
    ...
    show onka smile with Dissolve(DISSOLVE_TIME)
    onka "Когда Ваш выход?"
    hide onka
    show maks regular with Dissolve(DISSOLVE_TIME)
    maks "После первой звезды."
    hide maks
    show onka confused with Dissolve(DISSOLVE_TIME)
    ...
    hide maks
    show onka thinking with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    hide black
    show onka sneaky with Dissolve(DISSOLVE_TIME)
    ...
    hide onka
    show fox collar_angry with Dissolve(DISSOLVE_TIME)
    fox "Из низшей."
    hide fox
    show onka smile with Dissolve(DISSOLVE_TIME)
    onka "Что думаешь насчет перехода в высшую касту?"
    hide onka
    show fox collar_shock with Dissolve(DISSOLVE_TIME)
    ...
    hide onka
    show fox shock with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show fox angry with Dissolve(DISSOLVE_TIME)
    fox "Некрасиво перебивать! "
    fox "Я, между прочим, объяснялся с хозяином Фабрики Чипов, с Самим..."
    hide fox
    show onka danger with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show fox smile with Dissolve(DISSOLVE_TIME)
    fox "Благодарю!"
    hide fox
    hide fox
    show black regular_confused with Dissolve(DISSOLVE_TIME)
...
label scene_8:
    ...
    show onka sad with Dissolve(DISSOLVE_TIME)
    ...
    hide onka
    show maks fight with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    hide black
    show onka victory with Dissolve(DISSOLVE_TIME)
...
label scene_10 :
    ...
    hide black
    show onka angry with Dissolve(DISSOLVE_TIME)
...
label scene_11 :
    ...
    hide fox
    show black regular_disgust with Dissolve(DISSOLVE_TIME)
...
label scene_12 :
    ...
    show hight_fox smile with Dissolve(DISSOLVE_TIME)
    narrator "На лавках обедали или читали лисы. Вечна уставилась на одного из них, с ланчбоксом."
    show hight_fox angry with Dissolve(DISSOLVE_TIME)
...
label scene_13 :
    ...
    hide black
    show natasha regular with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show natasha smile with Dissolve(DISSOLVE_TIME)
    ...
    hide black
    show natasha angry with Dissolve(DISSOLVE_TIME)
    ...
    hide maks
    show natasha sad with Dissolve(DISSOLVE_TIME)
...
label scene_15:
    ...
    hide onka
    show black surprised_var with Dissolve(DISSOLVE_TIME)
...
label scene_16:
    ...
    hide onka
    show black disgust_var with Dissolve(DISSOLVE_TIME)
...
label scene_17:
    ...
    hide maks
    show black regular_blood with Dissolve(DISSOLVE_TIME)
...
label scene_19 :
    ...
    show wild_fox regular with Dissolve(DISSOLVE_TIME)
    ...
    hide vechna
    hide vechna
    show wild_fox crazy with Dissolve(DISSOLVE_TIME)
...
label scene_25 :
    ...
    show black fear_regular with Dissolve(DISSOLVE_TIME)
...
label scene_27:
    ...
    show black mad_var with Dissolve(DISSOLVE_TIME)
    ...
    show black fear_var with Dissolve(DISSOLVE_TIME)
